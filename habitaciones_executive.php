<?php include("header.php");?>
        ...
        <div class="habitaciones_detalle">
	        ...
	        <div class="col-md-8 borde">
		        ...
		        <p>Confortables y cálidas habitaciones de 36 m2, donde podrá disfrutar de la tecnología y servicios adicionales, pensados para que su estadía no tenga preocupaciones. Se puede armar King o Twin y admite cama adicional.<br><br>
...
· Grupo electrógeno
        ...
        <form action="https://reservations.travelclick.com/73742#/guestsandrooms" method="get" target="_blank">
	        ...
	        <img src="img_urquiza/KER_URQUIZA_Website_HABITACIONES_Fichas_EXECUTIVE.jpg" alt="01Standard_Banner_inferior_Standard" class="foto img-responsive">
        </div>
